...
- Incoming friend requests appear below the Contacts search field and can be expanded, accepted, or declined without leaving the workspace. Accepting a request immediately adds the shared direct conversation to both users' Chats lists.
