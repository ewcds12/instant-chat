...
- The Contacts workspace provides an alphabetical directory with local name and ID filtering, exact ID lookup for new people, an inline friend-request drawer, a selected-contact detail panel with an enlarged profile-photo preview, real shared photos, files, and web links, safe removal confirmation, and direct-message navigation.
