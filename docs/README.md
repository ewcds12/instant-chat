...
- Text-message context menus provide on-device translation into English, Simplified Chinese, or Japanese. The selected target language and completed translations persist locally, and translated text appears below the unchanged original message after refresh or reopening the chat.
