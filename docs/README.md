...
- Explore provides one authenticated global feed visible to every Instant Chat account. Users can publish up to 1,000 characters and four photos, expand or collapse long post text without nested scrolling, navigate between photos in the enlarged viewer, scroll through cursor-paginated posts, delete their own posts, report another user's post, and block or unblock authors without changing contact or chat relationships.
